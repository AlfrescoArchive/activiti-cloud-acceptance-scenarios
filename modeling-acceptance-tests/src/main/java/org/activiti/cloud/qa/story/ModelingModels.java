...
public class ModelingModels {
    ...
    public void checkCurrentModelContainsVariables(List<String> processVariables) {
        modelingModelsSteps.checkCurrentModelContainsVariables(processVariables);
    }
    ...
    public void addProcessVariableInCurrentModeladdProcessVariableInCurrentModel(String processVariable) {
        modelingModelsSteps.addProcessVariableInCurrentModel(processVariable);
    }
}
