...
Scenario: Start a process containing multi-instance cloud connector
Given the user is authenticated as testuser
...
Then the query process instance has an integer variable named executionCount with value 3
Then the query process instance has an integer variable named nrOfInstances with value 3
Then the query process instance has an integer variable named nrOfCompletedInstances with value 3
Then the query process instance has an integer variable named nrOfActiveInstances with value 0
Then the query process instance has an integer variable named loopCounter with value 0
